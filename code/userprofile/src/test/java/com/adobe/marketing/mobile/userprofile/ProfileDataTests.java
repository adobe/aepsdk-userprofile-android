...
public class ProfileDataTests {
    ...
    @Mock private NamedCollection namedCollection;
    ...
    public void test_construction_withDataStoreServiceError()
    ...
    public void test_loadPersistenceData() {
        ...
        when(namedCollection.getString(keyCaptor.capture(), defaultValueCaptor.capture()))
    ...
    public void test_loadPersistenceData_invalidJson() {
        ...
        ArgumentCaptor<String> defaultValueCaptor = ArgumentCaptor.forClass(String.class);
        when(namedCollection.getString(keyCaptor.capture(), defaultValueCaptor.capture()))
                .thenReturn("{this-is-not-a-valid-json}");
