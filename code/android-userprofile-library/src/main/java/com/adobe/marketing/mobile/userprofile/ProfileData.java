...
class ProfileData {
    ...
    ProfileData() throws MissingPlatformServicesException {
        namedCollection = ServiceProvider.getInstance().getDataStoreService().getNamedCollection(USER_PROFILE_DATASTORE_NAME);
     ...
     *
     * @return {@code True} indicating the stored data was retrieved and parsed to a {@code Map} correctly
     */
     ...
     * <ul>
     * 		<li> If the attribute key did not exist before, it will be created. </li>
     * 		<li> If it did exist, it will be updated. </li>
     * 		<li> If it did exist, and the attribute value is null, the key will be deleted from the map. </li>
     * </ul>
     *
